...
export function WhatsDriving({ mortgageRates }: WhatsDrivingProps) {
  return (
    <div>
      <SectionHeader
      ...
      <div className="grid gap-6" style={{ gridTemplateColumns: '1fr 1fr' }}>
        <Card padding="none" className="p-6 flex flex-col gap-3.5">
          ...
          <h3 className="font-display text-[22px] font-semibold tracking-tight leading-snug">
            Federal job-loss data landing soon
          </h3>
          <p className="text-sm text-fg-2 leading-snug">
            Coming with federal-employment ingest (QCEW). Will show county-level exposure to
