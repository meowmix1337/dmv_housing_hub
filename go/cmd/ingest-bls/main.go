// Command ingest-bls runs the BLS ingester and writes the result to
// go/.cache/bls.json. Loads .env from project root, then go/.env as override.
package main
...
func main() {
	...
	cachePath := filepath.Join(".cache", "bls.json")
